...
public class TestHarness {
	...
	class ResultCallback implements GameEngineCallback {
		int countPlayerRollOutcome = 0;
		int countHouseRollOutcome = 0;

		public void clearResults() {
			this.countPlayerRollOutcome = this.countHouseRollOutcome = 0;
		}
	...
	public TestHarness() {
		...
		System.out.println("\nThe test harness score is: " + this.score
				+ "/ 8 marks. NOTE: 1 additional mark will be"
	...
	private void testCallbackCalls() {
		...
		try {
			this.testNumber = 8;
			System.out
			.println("\nTest 08 - Test Outcome Callback Calls (1.0 mark)");
			...
			if ((this.resultCallBack.countPlayerRollOutcome == 1)
				...
				System.out
						.println("Game outcomes called once each for player and house: (1.0 mark)");
				this.score += 1.0;
			} else
